...
#pip3 install pytorch==1.2.0 torchvision==0.4.0 cudatoolkit=10.0 -c pytorch
...
```
python3 train.py --name gmm_train_new --stage GMM --workers 4 --save_count 5000 --shuffle
```
